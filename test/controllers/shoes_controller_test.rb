...
class ShoesControllerTest < ActionController::TestCase
  ...
  test "should create shoe" do
    assert_difference('Shoe.count') do
      post :create, shoe: { category_id: @shoe.category_id, company_id: @shoe.company_id, description: @shoe.description, name: @shoe.name, price: @shoe.price }
    end
  ...
  test "should update shoe" do
    patch :update, id: @shoe, shoe: { category_id: @shoe.category_id, company_id: @shoe.company_id, description: @shoe.description, name: @shoe.name, price: @shoe.price }
    assert_redirected_to shoe_path(assigns(:shoe))
  end
